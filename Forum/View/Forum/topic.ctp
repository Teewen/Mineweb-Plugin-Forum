...
<script type="text/javascript">
	$(function() {
		$(document).ready(function(){
			forumtitle1 = $("#forum-title-1").text().replace(/_._/g, "-");
			$("#forum-title-1").text(forumtitle1);
			forumtitle2 = $("#forum-title-2").text().replace(/_._/g, "-");
			$("#forum-title-2").text(forumtitle2);
			headerforum = $(".fh5co-center-position").text().replace(/_._/g, "-");
			$(".fh5co-center-position").html('<h2 class="animate-box fadeInUp animated">' + headerforum + '</h2>');
			titleforum = $("title").text().replace(/_._/g, "-");
			$("title").html(titleforum);
		});
	});
</script>
            ...
            <div class="col-md-10 col-xs-12">
                <ol class="forum-breadcrumb">
                    ...
                    <li class="forum-breadcrumb-child">
                        <span id="forum-title-1"><?= $this->Text->truncate(h($title), 70); ?></span>
                    </li>
                </ol>
            </div>
        ...
        <div class="forum-forum">
            <div class="forum-forum-header">
                <p class="forum-forum-title">
                    ...
                    <span id="forum-title-2"><?= $this->Text->truncate(h($title), 144); ?></span>
                </p>
            </div>
        </div>
