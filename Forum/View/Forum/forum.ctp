                       ...
                       <div class="forum-category">
                           <div class="row">
                               ...
                               <div class="col-xs-7 col-md-5 col-sm-6">
                                   ...
                                   <h3 class="forum-category-title inline">
                                       <a style="color:<?php if(!empty($internal['topic_color'])) echo $internal['topic_color']; ?>" href="<?= $topic['Topic']['href']; ?>"><?= $this->Text->truncate(h(str_replace("_._", "-", $topic['Topic']['name'])), 50); ?></a>
                                   </h3>
                                   <div class="forum-category-description">
