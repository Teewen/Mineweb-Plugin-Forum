                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-3 hidden-mob forum-category-last">
                                        <?php if($forum['Forum']['nb_discussion'] != 0 && $forum['Forum']['nb_message'] != 0): ?>
                                            <a style="color:<?php if(!empty($internal['last_colortitle'])) echo $internal['last_colortitle']; ?>" href="<?= $forum['Forum']['topic_last_href']; ?>"><?= $this->Text->truncate(h(str_replace("_._", "-", $forum['Forum']['topic_last_title'])), 70); ?></a><br/>
