...
<script type="text/javascript">
    function ReplaceDrawn(){
        forumtitle = $("input[name='name']").val().replace(/-/g, "_._");
        $("input[name='name']").val(forumtitle);
    }
</script>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php if($perms['FORUM_RENAME_TOPIC']): ?>
                        <div class="row mt20">
                            <form action="<?= $this->Html->url('/forum/action/topic/rename/'.$topic['Topic']['id_topic']); ?>" method="post" onsubmit="ReplaceDrawn()">
                                <input name="data[_Token][key]" value="<?= $csrfToken ?>" type="hidden" />
                                <div class="col-md-10">
                                    <input type="text" value="<?= h(str_replace('_._', '-', $topic['Topic']['name'])); ?>" name="name" class="form-control" />
                                </div>
                                <div class="col-md-2">
                                    <input type="submit" class="btn btn-primary" value="Modifier le titre du topic" />
                                </div>
                            </form>
                        </div>
                    <?php endif; ?>
                    <?php if($perms['FORUM_MOOVE_TOPIC']): ?>
                        <div class="row mt20">
                            <form action="<?= $this->Html->url('/forum/action/topic/moove/'.$topic['Topic']['id_topic']); ?>" method="post">
                                ...
                                <div class="col-md-2">
                                    <input type="submit" class="btn btn-primary" value="Déplacer le topic" />
                                </div>
                            </form>
                        </div>
                    <?php endif; ?>
                        ...
                        <?php if(!empty($ranks)): ?>
                            <div class="row">
                                <form action="<?= $this->Html->url('/forum/action/topic/view/'.$topic['Topic']['id_topic']); ?>" method="post">
                                    ...
                                    <div class="col-md-2">
                                        <input type="submit" class="btn btn-primary" value="Modifier la visibilité du topic" />
                                    </div>
                                </form>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if(!empty($tags)): ?>
                            <div class="row">
                                <form action="<?= $this->Html->url('/forum/action/topic/tag/'.$topic['Topic']['id_topic']); ?>" method="post">
                                    ...
                                    <div class="col-md-2">
                                        <input type="submit" class="btn btn-primary" value="Modifier les labels du topic" />
                                    </div>
                                </form>
                            </div>
                        <?php endif; ?>
